const s = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), r = [
  s + "/_app/immutable/entry/app.e24ac50a.js",
  s + "/_app/immutable/assets/0.731183ec.css",
  s + "/_app/immutable/nodes/0.c72192f2.js",
  s + "/_app/immutable/nodes/1.43eae8d8.js",
  s + "/_app/immutable/assets/2.0ec1ad69.css",
  s + "/_app/immutable/nodes/2.b92a3846.js",
  s + "/_app/immutable/chunks/index.3a043c0e.js",
  s + "/_app/immutable/chunks/scheduler.c12c5fa2.js",
  s + "/_app/immutable/chunks/singletons.740254e0.js",
  s + "/_app/immutable/entry/start.3e5380f4.js"
], p = [
  s + "/.nojekyll",
  s + "/favicon.svg",
  s + "/manifest.json"
], i = "1690683998701", o = `cache${i}`, l = r.concat(p), u = new Set(l);
