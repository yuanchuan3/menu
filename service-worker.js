const s = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), r = [
  s + "/_app/immutable/entry/app.ce2d9d68.js",
  s + "/_app/immutable/assets/0.731183ec.css",
  s + "/_app/immutable/nodes/0.c72192f2.js",
  s + "/_app/immutable/nodes/1.e8e73638.js",
  ...
  s + "/_app/immutable/chunks/singletons.97804c6d.js",
  s + "/_app/immutable/entry/start.56cef4e1.js"
], p = [
  s + "/.nojekyll",
  s + "/favicon.svg",
  s + "/manifest.json"
], i = "1690687045952", o = `cache${i}`, l = r.concat(p), u = new Set(l);
