const e = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), r = [
  e + "/_app/immutable/entry/app.9f839b2d.js",
  e + "/_app/immutable/assets/0.852acbe6.css",
  e + "/_app/immutable/nodes/0.217d78a4.js",
  e + "/_app/immutable/nodes/1.e1aba6b8.js",
  ...
  e + "/_app/immutable/chunks/singletons.9cb2b11b.js",
  e + "/_app/immutable/entry/start.0f1befbc.js"
], p = [
  e + "/.nojekyll",
  e + "/favicon.svg",
  e + "/manifest.json"
], i = "1690647235811", o = `cache${i}`, l = r.concat(p), u = new Set(l);
